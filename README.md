...
##  WITH THE WALLET SYSTEM FOR WOOCOMMERCE YOU CAN:
...
* The merchant can see all users' transaction history (filter by users) and download it in a PDF file. 
...
**19. Recharge Wallet Accounts With A CSV File**

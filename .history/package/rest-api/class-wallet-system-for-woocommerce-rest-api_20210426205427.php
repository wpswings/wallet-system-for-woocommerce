...
class Wallet_System_For_Woocommerce_Rest_Api {
	...
	public function mwb_wsfw_user_wallet_transactions( $request ) {
		...
		if ( isset( $params['transaction_type'] ) && isset( $params['amount'] ) && isset( $params['payment_method'] ) ) { 
			...
			$mwb_wsfw_response = new WP_REST_Response( array( 'response' => 'Invalid Request' ), 401 );
		}

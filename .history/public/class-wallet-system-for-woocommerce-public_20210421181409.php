...
class Wallet_System_For_Woocommerce_Public {
	...
	public function wsfw_public_enqueue_scripts() {
		...
		wp_localize_script( $this->plugin_name, 'wsfw_public_param', array( 'ajaxurl' => admin_url( 'admin-ajax.php' ),'datatable_pagination_text' => __( 'Rows per page _MENU_', 'wallet-system-for-woocommerce' ),

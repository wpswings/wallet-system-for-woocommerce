...
<div class='content active'>
    ...
    <form method="post" action="" id="mwb_wallet_transfer_form">
        ...
        <p class="mwb-wallet-field-container form-row form-row-wide">
            ...
            <input type="number"  min="0" max="<?php esc_attr_e( $wallet_bal, 'wallet-system-for-woocommerce' ); ?>" id="mwb_wallet_transfer_amount" name="mwb_wallet_transfer_amount" required="">
        </p>

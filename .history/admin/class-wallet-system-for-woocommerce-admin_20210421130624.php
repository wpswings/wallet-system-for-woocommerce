...
class Wallet_System_For_Woocommerce_Admin {
	...
	*/
	...
	public function custom_code_in_head() {
		...
		.wp-list-table.walletrechargeorders thead tr .column-date1, .wp-list-table.walletrechargeorders tbody tr .column-date1, .wp-list-table.walletrechargeorders thead tr .column-date1 {
			display:none;
		}	
		</style>
    	';

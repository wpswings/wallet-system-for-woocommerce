	...
	public function  wsfw_add_user_wallet_field( $user ) {
		...
		echo wc_price( $wallet_bal ); ?> </h2>
			<table class="form-table">
				<tr>
					<th><label for="mwb_wallet"><?php esc_html_e( 'Credit', 'wallet-system-for-woocommerce' ); ?>Amount</label></th>
					<td>
						<input type="number" name="mwb_wallet" id="mwb_wallet">
						<span class="description"><?php esc_html_e( 'Credit', 'wallet-system-for-woocommerce' ); ?>Add/deduct money to/from wallet</span>
						<p class="error" ></p>
					</td>
				</tr>
				<tr>

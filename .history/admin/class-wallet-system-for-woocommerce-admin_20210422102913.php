	...
	public function wsfw_save_user_wallet_field( $user_id ) {
		if ( current_user_can( 'edit_user', $user_id) ) {
			...
			if ( 'credit' === $action ) {
				...
				$transaction_type = esc_html__( 'Wallet Balance', 'wallet-system-for-woocommerce' );'Credited by admin';
				$message = esc_html__( 'Wallet Balance', 'wallet-system-for-woocommerce' );;
			} elseif ( 'debit' === $action ) {

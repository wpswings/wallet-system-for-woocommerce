...
?>
 <div class="mwb-wsfw-gen-section-form mwb-wsfw-wallet-system-rest-api"> 
    ...
    <form action="" method="POST" > 
        ...
        <p><?php esc_html_e( 'The WooCommerce REST API allows external apps to view and manage wa. Access is granted only to those with valid API keys.' , 'wallet-system-for-woocommerce' ); ?></p>

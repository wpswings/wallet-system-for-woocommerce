...
if ( isset( $_POST['update_wallet'] ) && ! empty( $_POST['update_wallet'] ) ) {
	...
	if ( $update ) {
        ...
        if ( isset( $send_email_enable ) && 'on' === $send_email_enable ) {
            ...
            add_filter( 'wp_mail_from', array ( 'Wallet_System_For_Woocommerce', 'yoursite_wp_mail_from' ) );
            
            add_filter('wp_mail_from_name',array ( 'Wallet_System_For_Woocommerce', 'yoursite_wp_mail_from_name' ) );

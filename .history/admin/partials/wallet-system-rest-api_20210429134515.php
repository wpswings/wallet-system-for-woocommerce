...
?>
 <div class="mwb-wsfw-gen-section-form mwb-wsfw-wallet-system-rest-api"> 
    ...
    <p>For authentication you need Consumer Key  <strong>consumer_key</strong> and Consumer Secret  <strong>consumer_secret</strong> keys.</p>

    <h5><?php esc_html_e( 'Retrieve particular user wallet amount' , 'wallet-system-for-woocommerce' ); ?></h5> 
    <p>Retrieves wallet balance an existing contact. HTTP request is:</p>
    <p><strong>GET {your_url}/wp-json/wsfw-route/v1/wallet/&lt;id&gt;?consumer_key=XXXX&consumer_secret=XXXX</strong> where &lt;id&gt; is an user id of user.<p>
    <p>Example : https://www.example.com/wp-json/wsfw-route/v1/wallet/1?consumer_key=XXXX&consumer_secret=XXXX </p>
    <p>JSON response example:</p>
    <pre>"23.34"</pre>

    <h5><?php esc_html_e( 'Retrieve particular user wallet transactions' , 'wallet-system-for-woocommerce' ); ?></h5> 
f    <p><strong>GET {your_url}/wp-json/wsfw-route/v1/wallet/&lt;id&gt;?consumer_key=XXXX&consumer_secret=XXXX</strong> where &lt;id&gt; is an user id of user.<p>
    <p>Example : https://www.example.com/wp-json/wsfw-route/v1/wallet/1?consumer_key=XXXX&consumer_secret=XXXX </p>
    <p>JSON response example:</p>
    <pre>"23.34"</pre>

...
?>
 <div class="mwb-wsfw-gen-section-form mwb-wsfw-wallet-system-rest-api"> 
    ...
    <p>Retrieves wallet balance an existing contact. The only parameter needed is the ID for the contact which is returned in the response upon contact creation.</p>

...
<div class="mwb-wpg-transcation-section-search">
    ...
    <table>
            <tbody>
                ...
                <tr>
                    <td><input name="min" id="min" type="text" placeholder="From" ><img class="ui-datepicker-trigger" src="http://woocommerce.local/wp-content/plugins/invoice-system-for-woocommerce/admin/src/images/calender.png" alt="..." title="...">
                </td>
                </tr>
                <tr>

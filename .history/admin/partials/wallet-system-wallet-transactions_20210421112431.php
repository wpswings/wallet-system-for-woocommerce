...
<div class="mwb-wpg-gen-section-table-wrap mwb-wpg-transcation-section-table">
    ...
    <div class="mwb-wpg-gen-section-table-container">
        <table id="mwb-wpg-gen-table-all-transaction" class="mwb-wpg-gen-section-table dt-responsive" style="width:100%">
            <thead>
                <tr>
                    <th>#</th>
...
<?php
wp_enqueue_script( 'mwb-admin-transaction-table', WALLET_SYSTEM_FOR_WOOCOMMERCE_DIR_URL . 'admin/src/js/wallet-system-for-woocommerce-transaction-table.js', array( 'jquery' ), $this->version, false );
?>

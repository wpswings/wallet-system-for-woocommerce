 ...
 <div class="mwb-wsfw-gen-section-form mwb-wsfw-wallet-system-rest-api"> 
    ...
    <?php
        ...
        <table class="form-table">
            <tbody>
                <tr>
                    <th scope="row"><label><?php esc_html_e( 'Consumer key', 'wallet-system-for-woocommerce' ); ?></label></th>
                    <td>
                        <input type="text" name="consumer_key" class="mdc-text-field__input wsfw-number-class" required>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label><?php esc_html_e( 'Consumer secret', 'wallet-system-for-woocommerce' ); ?></label></th>
                    <td>
                        <input type="text" name="consumer_secret" class="mdc-text-field__input wsfw-number-class" required>
                    </td>
                </tr>
            </tbody>
        </table>

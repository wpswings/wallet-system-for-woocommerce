        ...
        <table class="form-table">
            <tbody>
                <tr>
                    ...
                    <td>
                        <input type="text" id="wallet_amount" name="consumer_key" class="regular-text" required>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label><?php esc_html_e( 'Consumer secret', 'wallet-system-for-woocommerce' ); ?></label></th>
                    <td>
                        <input type="text" id="wallet_amount"  name="consumer_secret" class="regular-text" required>
                    </td>
                </tr>
            </tbody>
        </table>

    ...
    <div class="mwb-overview__content">
        <div class="mwb-overview__content-description">
            ...
            <ul class="mwb-overview__features">
                ...
                <li><?php _e( 'Have compatibility with the <a href="' . admin_url('post.php?post='.$order_id.'&action=edit') . '" >Invoice System for WooCommerce</a>.', 'wallet-system-for-woocommerce' ); ?></li>
            </ul>
        </div> 

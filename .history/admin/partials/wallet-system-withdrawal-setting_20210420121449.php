                ...
                <tr>
                    ...
                    <td>
						<select id="filter_status" >
							<option value=""><?php esc_html_e( $user->display_name, 'wallet-system-for-woocommerce' ); ?>status</option>
							<option value="approved"><?php esc_html_e( $user->display_name, 'wallet-system-for-woocommerce' ); ?>approved</option>
							<option value="pending"><?php esc_html_e( $user->display_name, 'wallet-system-for-woocommerce' ); ?>pending</option>
							<option value="rejected"><?php esc_html_e( $user->display_name, 'wallet-system-for-woocommerce' ); ?>rejected</option>
						</select>
					</td>
                </tr>
            </tbody>

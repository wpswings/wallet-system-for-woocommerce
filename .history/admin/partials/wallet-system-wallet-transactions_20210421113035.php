...
<?php
wp_enqueue_script( 'mwb-admin-a--ltransaction-table', WALLET_SYSTEM_FOR_WOOCOMMERCE_DIR_URL . 'admin/src/js/wallet-system-for-woocommerce-transaction-table.js', array( 'jquery' ), $this->version, false );
?>

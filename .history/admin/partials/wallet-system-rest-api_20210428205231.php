    ...
    <?php
        ...
        <table class="form-table">
            <tbody>
                ...
                <tr>
                    <th scope="row"><label for="action_type"><?php esc_html_e( 'Consumer secret', 'wallet-system-for-woocommerce' ); ?></label></th>
                    <td>
                        <input type="text" id="wallet_amount" step="0.01" name="consumer_secret" class="regular-text" required>
                    </td>
                </tr>
            </tbody>
        </table>

...
?>
 <div class="mwb-wsfw-gen-section-form mwb-wsfw-wallet-system-rest-api"> 
    ...
    ?>
	<h5><?php esc_html_e( 'Retrieve Useaaars', 'wallet-system-for-woocommerce' ); ?></h5> 
    ...
    <p><?php esc_html_e( 'Retrieves all trasactions related to wallet. HTTP request is:', 'wallet-system-for-woocommerce' ); ?></p>

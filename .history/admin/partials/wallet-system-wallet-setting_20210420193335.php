			...
			<div class="mwb_wallet-edit-popup-content">
				<div class="mwb_wallet-edit-popup-amount">
					...
					<div class="mwb_wallet-edit-popup-control">
						<input type="number" name="mwb_wallet-edit-popup-input" id="mwb_wallet-edit-popup-input" min="0" pattern="[0-9]" title="Only integer number" class="mwb_wallet-edit-popup-fill">
						<p class="error"><?php esc_html_e( 'Debit Wallet', 'wallet-system-for-woocommerce' ); ?>Enter amount greater than 0.</p>
					</div>
				</div>
				<div class="mwb_wallet-edit-popup-amount">
					<div class="mwb_wallet-edit-popup-label">

...
<div class="mwb-wpg-transcation-section-search">
    ...
    <table>
            <tbody>
                ...
                <tr>
                    <td><input name="min" id="min" type="date" placeholder="From"></td>
                </tr>
                <tr>
                    <td><input name="max" id="max" type="date" placeholder="To"></td>
                </tr>
                <tr>
                ...
                if ( ! empty( $transactions ) && is_array($transactions ) ) {
                    ...
                    foreach ( $transactions as $transaction ) {
                        ...
                        <tr>
                            ...
                            ?></td>
                            <td class="hide_date" ><?php $date = date_create($transaction->date); echo $date;

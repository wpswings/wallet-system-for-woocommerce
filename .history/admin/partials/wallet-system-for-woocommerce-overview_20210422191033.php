    ...
    <div class="mwb-overview__content">
        <div class="mwb-overview__content-description">
            ...
            <ul class="mwb-overview__features">
                ...
                <li><?php _e( 'Have compatibility with the <a href="https://wordpress.org/plugins/invoice-system-for-woocommerce/" >Invoice System for WooCommerce</a>.', 'wallet-system-for-woocommerce' ); ?></li>
            </ul>
        </div> 

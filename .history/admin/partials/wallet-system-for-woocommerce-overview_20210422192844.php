    ...
    <div class="mwb-overview__content">
        ...
        <div class="mwb-overview__keywords">
            ...
            <div class="mwb-overview__keywords-item">
                <div class="mwb-overview__keywords-card">
                    <div class="mwb-overview__keywords-image">
                        <img src="<?php echo esc_html( WALLET_SYSTEM_FOR_WOOCOMMERCE_DIR_URL . 'admin/image/Icons_Wallet_as_Payment Method.jpg' ); ?>" alt="Wallet as a Payment Method">
                    </div>
                    <div class="mwb-overview__keywords-text">
            ...
            <div class="mwb-overview__keywords-item">
                <div class="mwb-overview__keywords-card mwb-card-support">
                    <div class="mwb-overview__keywords-image">
                        <img src="<?php echo esc_html( WALLET_SYSTEM_FOR_WOOCOMMERCE_DIR_URL . 'admin/image/Icons_Wallet_as a Discount .jpg' ); ?>" alt="Wallet as a Discount">
                    </div>
                    <div class="mwb-overview__keywords-text">

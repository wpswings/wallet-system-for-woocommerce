...
class Wallet_System_For_Woocommerce_Admin {
	...
	*/
	...
	public function custom_code_in_head() {
		...
		.order-status.status-trash{background:#eba3a3;color:#761919}.order-status.status-cancelled,.order-status.status-pending,.order-status.status-refunded{background:#e5e5e5}

$(document).ready(function() {
    $('.bulkactions').append('<input id="searchFrom" class="searchInput" type="text" placeholder="From"/><input id="searchTo" class="searchInput" type="text" placeholder="To" ><input type="button" id="clat" class="button" value="Clear">');

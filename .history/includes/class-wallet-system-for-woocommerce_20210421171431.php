...
class Wallet_System_For_Woocommerce {
	...
	private function wallet_system_for_woocommerce_public_hooks() {
		...
		if ( isset( $enable ) && 'on' === $enable ) {
			...
			$this->loader->add_action( 'init', $wsfw_plugin_public, 'mwb_wsfw_wallet_register_endpoint', 10 );
			...
			$this->loader->add_action( 'init', $wsfw_plugin_public, 'add_wallet_recharge_to_cart', 20 );

// /* global wps_wallet_admin_order_param, woocommerce_admin_meta_boxes, accounting, woocommerce_admin */

// jQuery(function (jQuery) {
//     var woo_wallet_order_items = {
//         init: function () {
//             if (wps_wallet_admin_order_param.is_refundable) {
//                 $('.refund-actions .do-manual-refund').before('<button type="button" class="button button-primary do-wallet-refund">' + wps_wallet_admin_order_param.i18n.refund + ' <span class="wc-order-refund-amount">' + wps_wallet_admin_order_param.default_price + '</span> ' + wps_wallet_admin_order_param.i18n.via_wallet + '</button>');
...
jQuery(document).ready(function(){
    ...
    if (wps_wallet_admin_order_param.is_refundable) {
                        jQuery('.refund-actions .do-manual-refund').before('<button type="button" class="button button-primary do-wallet-refund">' + wps_wallet_admin_order_param.i18n.refund + ' <span class="wc-order-refund-amount">' + wps_wallet_admin_order_param.default_price + '</span> ' + wps_wallet_admin_order_param.i18n.via_wallet + '</button>');
                        //$('#woocommerce-order-items').on('click', '.refund-actions .do-wallet-refund', this.do_wallet_refund);
    }

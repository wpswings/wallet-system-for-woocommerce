jQuery(document).ready(function() {
    jQuery('.bulkactions').append('<input id="searchFrom" class="searchInput" type="text" placeholder="From" autocomplete="off"/><input id="searchTo" class="searchInput" type="text" placeholder="To" autocomplete="off"><input type="button" id="clear_datefilter" class="button" value="Clear">');

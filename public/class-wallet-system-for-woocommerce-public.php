...
class Wallet_System_For_Woocommerce_Public {
							...
							if ( $customer_id > 0 ) {
								...
								if ( $walletamount < 0 ) {
									...
									if ( 'percent' == $wps_wsfw_intrest_type_amount_negative_balance && $wps_wsfw_intrest_type_amount_negative_balance ) {
										...
										if ( $wps_wsfw_intrest_amount_negative_balance > 0 && ! ( is_array( $wps_wsfw_intrest_amount_negative_balance ) ) ) {
	...
	public function wsfw_calculate_cashback_cart() {
		...
		$wsfw_max_cashbak_amount = ! empty( get_option( 'wps_wsfw_cashback_amount_max' ) ) ? get_option( 'wps_wsfw_cashback_amount_max' ) : '';
		$wsfw_cashbak_amount     = ! empty( get_option( 'wps_wsfw_cashback_amount' ) ) ? get_option( 'wps_wsfw_cashback_amount' ) : '';

...
<div class='content active'>
    <h2><?php esc_html_e( 'Wallet Recharge', 'wallet-system-for-woocommerce' ); ?></h2>
    <form method="post" action="" id="mwb_wallet_transfer_form">
        <p class="mwb-wallet-field-container form-row form-row-wide">
            <label for="mwb_wallet_recharge_amount"><?php esc_html_e( 'Amount', 'wallet-system-for-woocommerce' ); ?></label>
        ...
        <p class="mwb-wallet-field-container form-row">
            ...
            <input type="submit" class="button" id="mwb_recharge_wallet" name="mwb_recharge_wallet" value="Recharge Wallet">
        </p>
    </form>
</div>